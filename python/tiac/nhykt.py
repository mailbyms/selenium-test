...
class NhyktTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if not isExists:
            ...
            os.chmod(f'./photo/{date}', stat.S_IRWXU)
        else:
            pass
        try:
    ...
    def test001AdminLogin(self):  # admin登录
        ...
        try:
            ...
            print('admin登录失败')
            self.driver.save_screenshot(f'./photo/{date}/test001AdminLoginFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test002AddCourse(self):  # 新增学科
        ...
        try:
            ...
            print('新增学科失败')
            self.driver.save_screenshot(f'./photo/{date}/test002AddCourseFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test003AddSchool(self):  # 新增学校
        ...
        try:
            ...
            print('新增学校失败')
            self.driver.save_screenshot(f'./photo/{date}/test003AddSchoolFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test004AddTeacher(self):  # 新增老师
        ...
        try:
            ...
            # 老师手机号
            teacherFrom[1].send_keys('131' + str(config.Phone))
            # 老师教龄
            ...
            while True:
                ...
                if ele:
                    ...
                    # 重新输入
                    newTeacherPhone = '131' + str(config.Phone)
            ...
            print('新增老师失败')
            self.driver.save_screenshot(f'./photo/{date}/test004AddTeacherFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test005AddStudent(self):  # 新增学生
        ...
        try:
            ...
            # 输入学生家长手机号
            studentFrom[1].send_keys('132' + str(config.Phone))
            # 选择生日
            self.driver.find_element_by_css_selector('[class="ant-calendar-picker-input ant-input"]').click()
            self.driver.find_elements_by_css_selector('[class="ant-calendar-date"]')[0].click()
            # 选择学校
            ...
            while True:
                ...
                if ele:
                    ...
                    # 重新输入
                    newStudentPhone = '132' + str(config.Phone)
            ...
            print('新增学生失败')
            self.driver.save_screenshot(f'./photo/{date}/test005AddStudentFail.png')
            traceback.print_exc()
            assert False
    ...
    def test006AddTourClass(self): # 新增巡课
        ...
        try:
            ...
            print('新增巡课失败')
            self.driver.save_screenshot(f'./photo/{date}/test006AddTourClassFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test007AddLiveCourse(self):
        ...
        try:
            ...
            print('新增课程失败')
            self.driver.save_screenshot(f'./photo/{date}/test007AddLiveCourseFail.png')
            traceback.print_exc()
            assert False
        return courseName
    ...
    def test008CreateLive(self):
        ...
        try:
            ...
            print('排课失败')
            self.driver.save_screenshot(f'./photo/{date}/test008CreateLiveFail.png')
            traceback.print_exc()
            assert False
        return liveCourse
    ...
    def test009TeacherLogin(self):
        ...
        try:
            ...
            print('老师登录失败')
            self.driver.save_screenshot(f'./photo/{date}/test009TeacherLoginFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test010TeacherLive(self):
        ...
        try:
            ...
            print('老师直播失败')
            self.driver.save_screenshot(f'./photo/{date}/test010TeacherLiveFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test011StudentLogin(self):
        ...
        try:
            ...
            print('学生登录失败')
            self.driver.save_screenshot(f'./photo/{date}/test011StudentLoginFail.png')
            traceback.print_exc()
            assert False
        return
    ...
    def test012StudentIntoLive(self):
        ...
        try:
            ...
            print('学生进入直播间失败')
            self.driver.save_screenshot(f'./photo/{date}/test012StudentIntoLiveFail.png')
            traceback.print_exc()
            assert False
        return
